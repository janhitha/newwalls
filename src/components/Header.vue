<template>
    <Layout>
      ...
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><g-image src="~/logo.svg" class="w-40" alt="logo" /></g-link>
          <g-link v-else to="/"><g-image src="~/logo_dark_mode.svg" class="w-40" alt="logo" /></g-link>
        </div>
